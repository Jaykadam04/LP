...
public class Pass2 { 
  ...
  static HashMap<String, ArrayList<String>> mnemonic = new 
HashMap<String, ArrayList<String>>(); 
  static HashMap<Integer, ArrayList<String>> symboltab = new 
HashMap<Integer, ArrayList<String>>(); 
  static HashMap<Integer, ArrayList<String>> littable = new 
HashMap<Integer, ArrayList<String>>(); 
...
//Mnemonic Table   
  ...
  { 
   FileReader fr=new FileReader("C:\\Users\\MANSI 
DAUNDKAR\\Desktop\\Pass2.java\\mot.txt");     
...
//Symbol Table 
  private static void createSymbolTable() { 
   ...
   FileReader fr = null; 
   try { 
    fr = new FileReader("C:\\Users\\MANSI 
DAUNDKAR\\Desktop\\Pass2.java\\symtable.txt"); 
...
//Literal Table 
  private static void createLiteralTable() { 
   ...
   try { 
    fr = new FileReader("C:\\Users\\MANSI 
DAUNDKAR\\Desktop\\Pass2.java\\littable.txt"); 
   } catch (FileNotFoundException e1) { 
    e1.printStackTrace(); 
   }     
         BufferedReader br=new BufferedReader(fr);  
...
//Main 
 public static void main(String[] args) throws FileNotFoundException { 
  ...
  FileReader fr_input=new FileReader("C:\\Users\\MANSI 
DAUNDKAR\\Desktop\\Pass2.java\\input_ic.txt"); 
  FileWriter output = null; 
  try { 
   output = new FileWriter("C:\\Users\\MANSI 
DAUNDKAR\\Desktop\\Pass2.java\\final_output.txt"); 
 ...
 //Assembler directive instructions 
    ...
    { 
     ...
     int index=0; 
     String si=""; 
     for(int i=3; (Slast_token.charAt(i)!=')' && 
i<Slast_token.length()); i++) 
     { 
 ...
 if(Slast_token.charAt(0)=='1'||Slast_token.charAt(0)=='2'||Slast_token.charAt(0)=='3'||
 Slast_token.charAt(0)=='4') 
     { 
      temp+=Slast_token+" "; 
     } 
     else if(Slast_token.charAt(1)=='L')   
 //literal  
     { 
      int index=0; 
      String si=""; 
