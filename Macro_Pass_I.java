...
public class Macro_Pass_I { 
    ...
    //------------------------------Prepare MDT------------------------------------------------------------------------------------------ 
        ...
        private static void PreapareMDT() { 
            ...
            try { 
                writer = new FileWriter("C:\\Users\\mayur\\OneDrive\\Desktop\\macropass1\\src\\MDTable.txt"); 
    ...
    //------------------------------Prepare MNT------------------------------------------------------------------------------------------    
        ...
        private static void PrepareMNT() { 
            ...
            FileWriter writer = null; 
            try { 
                writer = new FileWriter("C:\\Users\\mayur\\OneDrive\\Desktop\\macropass1\\src\\MNTtable.txt"); 
            } catch (IOException e1) { 
                e1.printStackTrace(); 
            } 
    ...
    //------------------------------Prepare ALA------------------------------------------------------------------------------------------    
        ...
        private static void Ala_Table() throws IOException { 
            ...
            FileWriter writer = null; 
            try { 
                writer = new FileWriter("C:\\Users\\mayur\\OneDrive\\Desktop\\macropass1\\src\\ALAtable.txt"); 
            } catch (IOException e1) { 
                e1.printStackTrace(); 
            } 
    ...
    //----------------Main Method---------------------------------------------------------------------------------------------- 
        ...
        public static void main(String[] args) throws FileNotFoundException { 
            ...
            FileReader fr_input=new 
FileReader("C:\\Users\\mayur\\OneDrive\\Desktop\\macropass1\\src\\macroInput.txt"); 
            FileWriter fr_output = null; 
            try { 
                fr_output = new FileWriter("C:\\Users\\mayur\\OneDrive\\Desktop\\macropass1\\src\\macroOutput.txt"); 
            } catch (IOException e1) { 
